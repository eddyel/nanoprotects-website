...
// Chemin absolu vers le stub framer-motion pour le build SSR
const framerMotionStub = path.resolve(
  import.meta.dirname,
  "client/src/ssr-stubs/framer-motion.js"
);
...
export default defineConfig({
  ...
  resolve: {
    alias: {
      // En mode SSR : remplace framer-motion par le stub statique
      // En mode client normal : utilise le vrai framer-motion (comportement inchangé)
      ...(isSsr ? { "framer-motion": framerMotionStub } : {}),
