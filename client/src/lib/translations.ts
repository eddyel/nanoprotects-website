...
export const translations: Record<Language, Translations> = {
  fr: {
    ...
    seo: {
      ...
      keywords: 'nettoyage bejmat marrakech, protection zellige, carreaux ciment beldi, pierre taza traitement, marbre nettoyage marrakech, surfaces traditionnelles marocaines, hôtels marrakech, riads marrakech, nanotechnologie surfaces, imperméabilisation bejmat, protection hydrofuge zellige, nettoyage surfaces marrakech',
      ogImage: '/images/plage-piscine-pierre-taza-hotel.webp',
      ogType: 'website',
    ...
    showroom: {
      ...
      desc5: 'Décapage Vernis, Nettoyage profond & Protection sublimée',
      desc6: 'Nettoyage profond & Protection sublimée',
      desc7: 'Nettoyage profond, Cristallisation & Protection sublimée',
      desc8: 'Détartrage, Nettoyage profond & Protection sublimée',
      desc9: 'Détartrage, nettoyage profond & Protection sublimée',
      desc10: 'Détartrage, Nettoyage profond & Protection sublimée',
      desc11: 'Nettoyage profond & Protection Invisible',
      desc12: 'Nettoyage profond & Protection Sublimé',
      desc13: 'Nettoyage profond & Protection Invisible Hydrofuge et Oléofuge',
      desc14: 'Nettoyage profond & Protection Sublimé',
      desc15: 'Nettoyage profond & Protection Invisible',
      ...
      title13: 'Sol Pierre de Taza – Hôtel Relais Châteaux',
    ...
    contact: {
      ...
      material16: 'Autre',
      autreMateriauLabel: 'Précisez le matériau :',
      errorPhoneInvalid: 'Format invalide. Utilisez : [Indicatif] [Numéro sans 0]. Exemple : 212 675987890',
      zone1: 'Sols',
      zone2: 'Escaliers',
      zone3: 'Murs',
      zone4: 'Mobilier',
    ...
    materials: {
      ...
      category1Title: 'Pierres & Marbres',
  ...
  ar: {
    ...
    seo: {
      ...
      keywords: 'تنظيف بيجمات مراكش، حماية زليج، بلاط إسمنت بلدي، حجر تازة، رخام مراكش، فنادق مراكش، رياض مراكش، نانوتكنولوجي أسطح، تنظيف أسطح تقليدية مغربية',
      ogImage: '/images/plage-piscine-pierre-taza-hotel.webp',
      ogType: 'website',
      twitterHandle: '@nanoprotects',
    },
    ...
    showroom: {
      ...
      title13: 'أرضية حجر تازة – فندق ريلاي أند شاتو',
    ...
    contact: {
      ...
      material14: 'الطين المضغوط',
      material15: 'الجص الجبسي',
      material16: 'آخر',
      autreMateriauLabel: 'حدد المادة:',
      errorPhoneInvalid: 'تنسيق غير صالح. استخدم: [رمز الدولة] [الرقم بدون 0]. مثال: 212 675987890',
      zone1: 'الأرضيات',
      zone2: 'السلالم',
      zone3: 'الجدران',
      zone4: 'الأثاث',
    ...
    about: {
      ...
      section2Text: 'نطور عمليات تدخل فعالة للغاية وسرية تماماً، مصممة للاندماج دون إزعاج في عمليات عملائنا. يعتمد التزامنا على الحوار المنهجي والتنفيذ الرشيد والموثوق.',
      section3Title: 'قيمنا',
  ...
  es: {
    ...
    seo: {
      ...
      keywords: 'limpieza bejmat marrakech, protección zellige, baldosas cemento beldi, piedra taza tratamiento, mármol marrakech, superficies tradicionales marroquíes, hoteles marrakech, riads marrakech, nanotecnología superficies, impermeabilización bejmat',
      ogImage: '/images/plage-piscine-pierre-taza-hotel.webp',
      ogType: 'website',
      twitterHandle: '@nanoprotects',
    },
    ...
    showroom: {
      title: 'La Excelencia en Imágenes',
      ...
      title13: 'Piso Piedra de Taza – Hotel Relais Châteaux',
    ...
    contact: {
      ...
      material16: 'Otro',
      autreMateriauLabel: 'Especifique el material:',
      errorPhoneInvalid: 'Formato inválido. Use: [Prefijo] [Número sin 0]. Ejemplo: 212 675987890',
      zone1: 'Pisos',
      zone2: 'Escaleras',
      zone3: 'Paredes',
      zone4: 'Muebles',
    ...
    materials: {
      ...
      category1Title: 'Piedras & Mármoles',
  ...
  en: {
    ...
    seo: {
      ...
      keywords: 'bejmat cleaning marrakech, zellige protection marrakech, beldi cement tiles treatment, taza stone cleaning, marble treatment marrakech, traditional moroccan surfaces, hotels marrakech, riads marrakech, nanotechnology surface protection, bejmat waterproofing',
      ogImage: '/images/plage-piscine-pierre-taza-hotel.webp',
      ogType: 'website',
      twitterHandle: '@nanoprotects',
    },
    ...
    showroom: {
      ...
      desc5: 'Varnish stripping, deep cleaning & sublime protection',
      desc6: 'Deep cleaning & sublime protection',
      desc7: 'Deep cleaning, crystallization & sublime protection',
      desc8: 'Descaling, deep cleaning & sublime protection',
      desc9: 'Descaling, deep cleaning & sublime protection',
      desc10: 'Descaling, deep cleaning & sublime protection',
      desc11: 'Deep cleaning & invisible protection',
      desc12: 'Deep cleaning & sublime protection',
      desc13: 'Deep cleaning & invisible hydrophobic and oleophobic protection',
      desc14: 'Deep cleaning & sublime protection',
      desc15: 'Deep cleaning & invisible protection',
      ...
      title13: 'Taza Stone Floor – Relais & Châteaux Hotel',
    ...
    contact: {
      ...
      material14: 'Rammed Earth',
      material15: 'Plaster Stucco',
      material16: 'Other',
      autreMateriauLabel: 'Specify the material:',
      errorPhoneInvalid: 'Invalid format. Use: [Country Code] [Number without 0]. Example: 212 675987890',
      zone1: 'Floors',
      zone2: 'Stairs',
      zone3: 'Walls',
      zone4: 'Furniture',
