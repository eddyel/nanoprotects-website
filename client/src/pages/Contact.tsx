...
// ===========================================
// LISTE COMPLÈTE DES PAYS AVEC ID UNIQUE
// ===========================================
const countries = [
  // Maroc en premier (défaut)
  { id: 'ma', code: "+212", flag: "🇲🇦", name: "Maroc", search: "maroc +212" },
  
  // Europe + UK
  { id: 'fr', code: "+33", flag: "🇫🇷", name: "France", search: "france +33" },
  { id: 'es', code: "+34", flag: "🇪🇸", name: "Espagne", search: "espagne spain +34" },
  { id: 'de', code: "+49", flag: "🇩🇪", name: "Allemagne", search: "allemagne germany +49" },
  { id: 'it', code: "+39", flag: "🇮🇹", name: "Italie", search: "italie italy +39" },
  { id: 'gb', code: "+44", flag: "🇬🇧", name: "Royaume-Uni", search: "royaume uni united kingdom uk +44" },
  { id: 'be', code: "+32", flag: "🇧🇪", name: "Belgique", search: "belgique belgium +32" },
  { id: 'ch', code: "+41", flag: "🇨🇭", name: "Suisse", search: "suisse switzerland +41" },
  { id: 'nl', code: "+31", flag: "🇳🇱", name: "Pays-Bas", search: "pays bas netherlands +31" },
  { id: 'pt', code: "+351", flag: "🇵🇹", name: "Portugal", search: "portugal +351" },
  { id: 'se', code: "+46", flag: "🇸🇪", name: "Suède", search: "suede sweden +46" },
  { id: 'no', code: "+47", flag: "🇳🇴", name: "Norvège", search: "norvege norway +47" },
  { id: 'dk', code: "+45", flag: "🇩🇰", name: "Danemark", search: "danemark denmark +45" },
  { id: 'fi', code: "+358", flag: "🇫🇮", name: "Finlande", search: "finlande finland +358" },
  { id: 'at', code: "+43", flag: "🇦🇹", name: "Autriche", search: "autriche austria +43" },
  { id: 'pl', code: "+48", flag: "🇵🇱", name: "Pologne", search: "pologne poland +48" },
  { id: 'gr', code: "+30", flag: "🇬🇷", name: "Grèce", search: "grece greece +30" },
  { id: 'cz', code: "+420", flag: "🇨🇿", name: "République tchèque", search: "republique tcheque czech +420" },
  { id: 'ro', code: "+40", flag: "🇷🇴", name: "Roumanie", search: "roumanie romania +40" },
  { id: 'hu', code: "+36", flag: "🇭🇺", name: "Hongrie", search: "hongrie hungary +36" },
  { id: 'tr', code: "+90", flag: "🇹🇷", name: "Turquie", search: "turquie turkey +90" },
  { id: 'ru', code: "+7", flag: "🇷🇺", name: "Russie", search: "russie russia +7" },
  { id: 'ua', code: "+380", flag: "🇺🇦", name: "Ukraine", search: "ukraine +380" },
  
  // Amériques - avec IDs distincts pour USA et Canada
  { id: 'us', code: "+1", flag: "🇺🇸", name: "États-Unis", search: "etats unis usa america +1" },
  { id: 'ca', code: "+1", flag: "🇨🇦", name: "Canada", search: "canada +1" },
  { id: 'mx', code: "+52", flag: "🇲🇽", name: "Mexique", search: "mexique mexico +52" },
  { id: 'br', code: "+55", flag: "🇧🇷", name: "Brésil", search: "bresil brazil +55" },
  { id: 'ar', code: "+54", flag: "🇦🇷", name: "Argentine", search: "argentine argentina +54" },
  { id: 'co', code: "+57", flag: "🇨🇴", name: "Colombie", search: "colombie colombia +57" },
  { id: 'cl', code: "+56", flag: "🇨🇱", name: "Chili", search: "chili chile +56" },
  { id: 'pe', code: "+51", flag: "🇵🇪", name: "Pérou", search: "perou peru +51" },
  { id: 've', code: "+58", flag: "🇻🇪", name: "Venezuela", search: "venezuela +58" },
  
  // Moyen-Orient
  { id: 'ae', code: "+971", flag: "🇦🇪", name: "Émirats Arabes Unis", search: "emirats arabes unis uae +971" },
  { id: 'sa', code: "+966", flag: "🇸🇦", name: "Arabie Saoudite", search: "arabie saoudite saudi +966" },
  { id: 'qa', code: "+974", flag: "🇶🇦", name: "Qatar", search: "qatar +974" },
  { id: 'kw', code: "+965", flag: "🇰🇼", name: "Koweït", search: "koweit kuwait +965" },
  { id: 'bh', code: "+973", flag: "🇧🇭", name: "Bahreïn", search: "bahrein bahrain +973" },
  { id: 'om', code: "+968", flag: "🇴🇲", name: "Oman", search: "oman +968" },
  { id: 'jo', code: "+962", flag: "🇯🇴", name: "Jordanie", search: "jordanie jordan +962" },
  { id: 'lb', code: "+961", flag: "🇱🇧", name: "Liban", search: "liban lebanon +961" },
  { id: 'iq', code: "+964", flag: "🇮🇶", name: "Irak", search: "irak iraq +964" },
  { id: 'sy', code: "+963", flag: "🇸🇾", name: "Syrie", search: "syrie syria +963" },
  { id: 'il', code: "+972", flag: "🇮🇱", name: "Israël", search: "israel +972" },
  { id: 'ye', code: "+967", flag: "🇾🇪", name: "Yémen", search: "yemen +967" },
  { id: 'ly', code: "+218", flag: "🇱🇾", name: "Libye", search: "libye libya +218" },
  { id: 'sd', code: "+249", flag: "🇸🇩", name: "Soudan", search: "soudan sudan +249" },
  
  // Afrique (hors Maroc déjà en tête)
  { id: 'dz', code: "+213", flag: "🇩🇿", name: "Algérie", search: "algerie algeria +213" },
  { id: 'tn', code: "+216", flag: "🇹🇳", name: "Tunisie", search: "tunisie tunisia +216" },
  { id: 'eg', code: "+20", flag: "🇪🇬", name: "Égypte", search: "egypte egypt +20" },
  { id: 'sn', code: "+221", flag: "🇸🇳", name: "Sénégal", search: "senegal +221" },
  { id: 'ci', code: "+225", flag: "🇨🇮", name: "Côte d'Ivoire", search: "cote d ivoire +225" },
  { id: 'cm', code: "+237", flag: "🇨🇲", name: "Cameroun", search: "cameroun cameroon +237" },
  { id: 'za', code: "+27", flag: "🇿🇦", name: "Afrique du Sud", search: "afrique du sud south africa +27" },
  { id: 'ng', code: "+234", flag: "🇳🇬", name: "Nigeria", search: "nigeria +234" },
  { id: 'ke', code: "+254", flag: "🇰🇪", name: "Kenya", search: "kenya +254" },
  { id: 'et', code: "+251", flag: "🇪🇹", name: "Éthiopie", search: "ethiopie ethiopia +251" },
  { id: 'gh', code: "+233", flag: "🇬🇭", name: "Ghana", search: "ghana +233" },
  { id: 'tz', code: "+255", flag: "🇹🇿", name: "Tanzanie", search: "tanzanie tanzania +255" },
  
  // Asie-Pacifique
  { id: 'cn', code: "+86", flag: "🇨🇳", name: "Chine", search: "chine china +86" },
  { id: 'jp', code: "+81", flag: "🇯🇵", name: "Japon", search: "japon japan +81" },
  { id: 'in', code: "+91", flag: "🇮🇳", name: "Inde", search: "inde india +91" },
  { id: 'kr', code: "+82", flag: "🇰🇷", name: "Corée du Sud", search: "coree du sud south korea +82" },
  { id: 'au', code: "+61", flag: "🇦🇺", name: "Australie", search: "australie australia +61" },
  { id: 'nz', code: "+64", flag: "🇳🇿", name: "Nouvelle-Zélande", search: "nouvelle zelande new zealand +64" },
  { id: 'sg', code: "+65", flag: "🇸🇬", name: "Singapour", search: "singapour singapore +65" },
  { id: 'my', code: "+60", flag: "🇲🇾", name: "Malaisie", search: "malaisie malaysia +60" },
  { id: 'id', code: "+62", flag: "🇮🇩", name: "Indonésie", search: "indonesie indonesia +62" },
  { id: 'th', code: "+66", flag: "🇹🇭", name: "Thaïlande", search: "thailande thailand +66" },
  { id: 'pk', code: "+92", flag: "🇵🇰", name: "Pakistan", search: "pakistan +92" },
  { id: 'bd', code: "+880", flag: "🇧🇩", name: "Bangladesh", search: "bangladesh +880" },
];
...
export default function Contact() {
  ...
  const [selectedCountryId, setSelectedCountryId] = useState('ma'); // Maroc par défaut
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.phone.trim()) {
      ...
      if (!phoneRegex.test(phoneDigits)) {
        newErrors.phone = t.contact.errorPhoneInvalid ?? 'Le numéro doit contenir exactement 9 chiffres';
      }
    }
  ...
  const handlePhoneChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (numbers.length > 3) {
      formatted = numbers.replace(/(\d{3})(\d{3})(\d{0,3})/, (match, p1, p2, p3) => {
            ...
            >
                ...
                {isAutreSelected && (
                  <div className="mt-4">
                    ...
                    {errors.autreMateriau && (
                      <p className="text-red-600 text-sm mt-1" role="alert">{errors.autreMateriau}</p>
                    )}
                  </div>
                )}
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-2 gap-3" role="group" aria-label={t.contact.protectionType}>
                  ...
                  >
                    {selectedProtectionTypes.includes(t.contact.protectionWater) && <Check className="w-4 h-4 inline mr-1" />}
                  ...
                  >
                    {selectedProtectionTypes.includes(t.contact.protectionOil) && <Check className="w-4 h-4 inline mr-1" />}
                  ...
                  >
                    {selectedProtectionTypes.includes(t.contact.protectionMineralization) && <Check className="w-4 h-4 inline mr-1" />}
                  ...
                  >
                    {selectedProtectionTypes.includes(t.contact.protectionAntiSlip) && <Check className="w-4 h-4 inline mr-1" />}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      if (errors.autreVille) setErrors(prev => ({ ...prev, autreVille: undefined }));
                    }}
                    aria-required="true"
                  ...
                  />
                  {errors.autreVille && (
                    <p id="autreVille-error" className="text-red-600 text-sm mt-1" role="alert">{errors.autreVille}</p>
                  )}
                </div>
              )}
