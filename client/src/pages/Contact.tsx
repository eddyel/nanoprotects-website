...
export default function Contact() {
  ...
  // États pour le champ téléphone - on stocke maintenant l'ID du pays
  ...
  const handlePhoneChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    // Ne garder que les chiffres, max 9, et ajouter des espaces tous les 3 chiffres pour l'affichage
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Submit to Netlify Forms - AVEC TOUS LES CHAMPS CONCATÉNÉS
      const formBody = new URLSearchParams({
        ...
        city: finalCity,
        // ✅ Ces champs apparaîtront maintenant dans l'email Netlify
