  ...
  return (
    <div className="min-h-screen">
      ...
      >
        <div className="container w-full px-6 md:px-8">
          <div className="max-w-3xl">
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-display font-bold text-white mb-6 text-shadow-lg animate-fade-up leading-tight">
              {t.hero.title}
            </h1>
            <p className="text-lg sm:text-xl md:text-2xl text-white/90 mb-8 text-shadow animate-fade-up animate-delay-200">
              {t.hero.subtitle}
            </p>
            <Button
      ...
      >
        <div className="container w-full px-6 md:px-8">
          <div className="max-w-3xl">
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-display font-bold text-white mb-6 text-shadow-lg leading-tight">
              {t.why.title}
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/90 leading-relaxed text-shadow">
              {t.why.subtitle}
            </p>
          </div>
        </div>
      ...
      >
        <div className="container w-full">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-6xl font-display font-bold text-white mb-4 text-shadow-lg">
              {t.what.title}
            </h2>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 max-w-5xl mx-auto px-4">
            ...
            <div className="glass-card text-white animate-fade-up">
              ...
              <h3 className="text-3xl font-bold mb-2 text-center">{t.what.benefit1Title}</h3>
              <p className="text-white/90 text-center">{t.what.benefit1Text}</p>
            </div>
            ...
            <div className="glass-card text-white animate-fade-up animate-delay-200">
              ...
              <h3 className="text-3xl font-bold mb-2 text-center">{t.what.benefit2Title}</h3>
              <p className="text-white/90 text-center">{t.what.benefit2Text}</p>
            </div>
            ...
            <div className="glass-card text-white animate-fade-up animate-delay-400">
              ...
              <h3 className="text-3xl font-bold mb-2 text-center">{t.what.benefit3Title}</h3>
              <p className="text-white/90 text-center">{t.what.benefit3Text}</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container w-full">
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 max-w-6xl mx-auto px-4">
            ...
            <div className="space-y-6">
              ...
              <div className="glass-card text-white">
                <div className="flex items-start space-x-4">
                  <Microscope className="flex-shrink-0 text-primary" size={32} />
                  <div>
                    <h4 className="text-xl font-semibold mb-2">{t.how.phase1Step1Title}</h4>
                    <p className="text-white/90 text-sm">{t.how.phase1Step1Text}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="glass-card text-white">
                <div className="flex items-start space-x-4">
                  <SprayCan className="flex-shrink-0 text-primary" size={32} />
                  <div>
                    <h4 className="text-xl font-semibold mb-2">{t.how.phase1Step2Title}</h4>
                    <p className="text-white/90 text-sm">{t.how.phase1Step2Text}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="glass-card text-white">
                <div className="flex items-start space-x-4">
                  <Shield className="flex-shrink-0 text-primary" size={32} />
                  <div>
                    <h4 className="text-xl font-semibold mb-2">{t.how.phase2Step1Title}</h4>
                    <p className="text-white/90 text-sm">{t.how.phase2Step1Text}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="glass-card text-white">
                <div className="flex items-start space-x-4">
                  <CheckCircle className="flex-shrink-0 text-primary" size={32} />
                  <div>
                    <h4 className="text-xl font-semibold mb-2">{t.how.phase2Step2Title}</h4>
                    <p className="text-white/90 text-sm">{t.how.phase2Step2Text}</p>
                  </div>
                </div>
              </div>
            </div>
