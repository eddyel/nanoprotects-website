      ...
      >
        ...
        <div className="relative z-10 container max-w-5xl px-6 text-center md:text-left flex-1 flex items-center">
          <div>
            ...
            <div className="flex flex-col gap-3 w-fit md:gap-4">
              <Button
                size="lg"
        ...
        <div className="absolute bottom-4 left-0 right-0 z-10 flex justify-center items-center gap-4 md:gap-6 md:bottom-2">
          <a
            ...
            aria-label="LinkedIn"
          >
            <span className="social-logo-linkedin-lg" />
          </a>
          ...
          <a
            ...
            aria-label="Facebook"
          >
            <span className="social-logo-facebook-lg" />
          </a>
          ...
          >
            <span className="social-logo-instagram-lg" />
          </a>
        </div>
      </section>
    </div>
