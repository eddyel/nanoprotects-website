        ...
        <div className="relative z-10 container max-w-5xl px-6 text-left flex-1 flex items-center">
          <div>
            ...
            <div className="flex flex-col gap-4 w-fit md:gap-4 gap-3">
              <Button size="lg" onClick={() => setLocation('/showroom')} className="text-lg px-6 py-6 font-semibold justify-center whitespace-nowrap border-2 btn-brand md:text-lg text-base md:px-6 px-4 md:py-6 py-4">
                {t.hero.realizationsButton}
              </Button>
              <Button size="lg" variant="outline" onClick={() => setLocation('/contact')} className="text-lg px-6 py-6 bg-transparent hover:bg-white/10 text-white border-2 border-[#A75C16] backdrop-blur-sm font-semibold justify-center whitespace-nowrap md:text-lg text-base md:px-6 px-4 md:py-6 py-4">
                {t.hero.cta}
              </Button>
            </div>
          </div>
