        ...
        <div className="container max-w-6xl">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8">
              ...
              <h3 className="font-semibold text-secondary text-lg mb-2">{t.what.benefit1Title}</h3>
            ...
            <div className="p-8">
              ...
              <h3 className="font-semibold text-secondary text-lg mb-2">{t.what.benefit2Title}</h3>
              <p className="text-gray-600 text-sm">
                {t.what.benefit2Text}
              </p>
            </div>
            ...
            <div className="p-8">
              ...
              <h3 className="font-semibold text-secondary text-lg mb-2">{t.what.benefit3Title}</h3>
              <p className="text-gray-600 text-sm">
                {t.what.benefit3Text}
              </p>
            </div>
